...
│   ├── market.py            # Binance OHLCV (with exchange fallback chain)
...
This fetches historical + latest data from Binance (or fallback exchanges), Fear & Greed Index, derivatives sources, and news headlines. Sets up the SQLite database automatically.

> **Geo-blocked?** If Binance is unavailable in your region, the system automatically tries OKX → Bybit → Kraken as fallbacks.
